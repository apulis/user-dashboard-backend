...
export class Logger {
  ...
  static getStackTrace(deep: number = 2): string {
    ...
    const lineNumber: number = (stackInfo.lineNumber as number);
    const columnNumber: number = (stackInfo.columnNumber as number);
    const fileName: string = (stackInfo.fileName as string);
